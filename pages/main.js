      ...
      var l = (function (t, e, n) {
        ...
        C = function (t) {
          ...
          for (e = 0; e < O.length; e++)
            if ((n = O[e] + i) in S.style) return { dom: n, css: T[e] + t };
        },
        z = (e.support = {
        ...
        U = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (j(n), e = F(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      (t.exports = function (t, e) {
        ...
        function y(e, n) {
          ...
          (r.handler = null),
            ...
            b.test(c) ? (r.handler = L) : c || (o ? (r.handler = A) : g());
        }
        function x(t) {
        ...
        function k(e, n) {
          ...
          if (s !== e.current) {
            ...
            e.panes.each(function (e, n) {
              var i = t(n);
              n.getAttribute(f) === s ? l.push(n) : i.hasClass(m) && d.push(n);
            });
            var h = t(l),
              b = t(d);
            if (n.immediate || r.immediate)
              return (
                h.addClass(m).each(v.intro),
                b.removeClass(m),
                void (w || i.redraw.up())
              );
