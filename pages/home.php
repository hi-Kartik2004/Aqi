...
<body class="body">
    <div class="f-banner">
        <div class="f-banner-container-between">
            <div class="f-banner-text-wrapper">
                ...
                <div class="f-paragraph-regular">This site uses Air Quality API by Weather bit, <span class="f-banner-text-span">25 requests </span>Per day!, If you find errors Quota has exhausted</div>
            </div>
            <div class="f-banner-block"><a href="https://github.com/hi-kartik2004/aqi" class="f-banner-button w-button">GitHub Repository Link</a>
    ...
    <div data-duration-in="300" data-duration-out="100" data-current="Tab 3" data-easing="ease" class="f-tab w-tabs">
        ...
        <div class="w-tab-content">
            <div data-w-tab="Tab 3" class="f-tab-pane w-tab-pane">
                            ...
                            <div>
                                <div class="f-margin-bottom-48">
                                    ...
                                    <div class="f-margin-bottom-16">
                                        <h1 class="f-h3-heading-2">Longitude &amp; Latitude | City</h1>
                                    </div>
                                    <p class="f-paragraph-large-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam pellentesque arcu sed felis</p>
                                </div>
                                <div class="">
                                    <form action="action.php" method="post" class="f-contact-form">
                                        <!-- <input type="text"> -->
                                        <div class="f-margin-bottom-16"><label for="Contact-Name-Field-02" class="f-field-label">Enter City</label><input type="text" name="city" required class="f-field-input w-input" maxlength="256" data-name="Contact Name Field 02" placeholder="" id="" /></div>
                                        <input name="city-btn" type="submit" value="Submit" data-wait="Please wait..." class="f-button-neutral w-button" />
                                    </form>
                                    <br>
                                    <hr>
                                    <br>
                    ...
                    <div class="f-container-regular">
                        <div class="w-layout-grid f-contact-grid">
                            <div>
                                <div class="f-margin-bottom-48">
                                    <div class="f-margin-bottom-08">
                                        <div class="f-heading-detail-small">Predicted AQi</div>
                                    </div>
                                    <div class="f-margin-bottom-16">
                                        <h1 class="f-h3-heading-2">Longitude &amp; Latitude | City</h1>
                                    </div>
                                ...
                                <form action="action.php" method="post" class="f-contact-form">
                                        <!-- <input type="text"> -->
                                        <div class="f-margin-bottom-16"><label for="Contact-Name-Field-02" class="f-field-label">Enter City</label><input type="text" name="city" required class="f-field-input w-input" maxlength="256" data-name="Contact Name Field 02" placeholder="" id="" /></div>
                                        <input name="p-city-btn" type="submit" value="Submit" data-wait="Please wait..." class="f-button-neutral w-button" />
                                    </form>
                                    <br>
                                    <hr>
                                    <br>
                                        ...
                                        <div class="w-layout-grid f-grid-two-column">
                                            <div id="w-node-_9612dce5-a985-78c0-2735-ea6cf37e2306-09c5cc4b" class="f-pricing-card-outline">
                                                <div class="f-pricing-card-title-wrapper">
                                                    <div class="div-block">
                                                        <div class="f-pricing-plan-type-wrapper">
                                                            <h5 class="f-h5-heading">#<?php if (isset($_SESSION['p_response'])) {
                                                                                            $r_data = $_SESSION['p_response'];
                                                                                            $city = $r_data['data'][0]['aqi'];
                                                                                            echo $city;
                                                                                        } ?></h5>
                                                            <div class="f-badge-filled">
                                                    ...
                                                    <div class="f-pricing-price-text"><?php if (isset($_SESSION['p_response'])) {
                                                                                            $r_data = $_SESSION['p_response'];
                                                                                            $city = $r_data['city_name'];
                                                                                            echo $city;
                                                                                        } ?><span class="f-pricing-month-span">/<?php if (isset($_SESSION['c_response'])) {
                                                ...
                                                <div class="w-layout-grid f-pricing-feature-grid">
                                                    ...
                                                    <iframe src="prediction_chart.php" style="overflow: scroll !important; width:350px;" width="100%;" height="100%;" frameborder="0"> <canvas id="myChart"></canvas></iframe>
                                                    ...
                                                    <script>
                                                        ...
                                                        var myChart = new Chart(ctx, {
                                                            ...
                                                            data: {
                                                                ...
                                                                datasets: [{
                                                                        data: [86, 114, 106, 106, 107, 111, 133, 233, 123, 213, 123],
                                                ...
                                                <div class="f-line-large"><a href="prediction_chart.php" class="link-3">Know more</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="f-container-regular">
                        <div class="w-layout-grid f-contact-grid">
                            <div>
                                <div class="f-margin-bottom-48">
                                    <div class="f-margin-bottom-08">
                                        <div class="f-heading-detail-small">Past AQi</div>
                                    </div>
                                    <div class="f-margin-bottom-16">
                                        <h1 class="f-h3-heading-2">Longitude &amp; Latitude | City</h1>
                                    </div>
                                ...
                                <form action="action.php" method="post" class="f-contact-form">
                                        <!-- <input type="text"> -->
                                        <div class="f-margin-bottom-16"><label for="Contact-Name-Field-02" class="f-field-label">Enter City</label><input type="text" name="city" required class="f-field-input w-input" maxlength="256" data-name="Contact Name Field 02" placeholder="" id="" /></div>
                                        <input name="past-city-btn" type="submit" value="Submit" data-wait="Please wait..." class="f-button-neutral w-button" />
                                    </form>
                                    <br>
                                    <hr>
                                    <br>
                                        ...
                                        <div class="w-layout-grid f-grid-two-column">
                                            <div id="w-node-_69800d61-8e35-c874-8a14-5d1f7d520431-09c5cc4b" class="f-pricing-card-outline">
                                                <div class="f-pricing-card-title-wrapper">
                                                    <div class="div-block">
                                                        <div class="f-pricing-plan-type-wrapper">
                                                            <h5 class="f-h5-heading">#<?php if (isset($_SESSION['past_response'])) {
                                                                                            $r_data = $_SESSION['past_response'];
                                                                                            $city = $r_data['data'][0]['aqi'];
                                                                                            echo $city;
                                                                                        } ?></h5>
                                                            <div class="f-badge-filled">
                                                    ...
                                                    <div class="f-pricing-price-text"><?php if (isset($_SESSION['past_response'])) {
                                                                                            $r_data = $_SESSION['past_response'];
                                                                                            $city = $r_data['city_name'];
                                                                                            echo $city;
                                                                                        } ?><span class="f-pricing-month-span">/<?php if (isset($_SESSION['past_response'])) {
                                                                                                                                    $r_data = $_SESSION['past_response'];
                                                                                                                                    $city = $r_data['country_code'];
                                                                                                                                    echo $city;
                                                                                                                                } ?></span></div>
                                                ...
                                                <div class="w-layout-grid f-pricing-feature-grid">
                                                    ...
                                                    <iframe src="past_chart.php" style="overflow: scroll !important; width:350px;" width="100%;" height="100%;" frameborder="0"> <canvas id="myChart"></canvas></iframe>
                                                ...
                                                <div class="f-line-large"><a href="past_chart.php" class="link-3">Know more</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
